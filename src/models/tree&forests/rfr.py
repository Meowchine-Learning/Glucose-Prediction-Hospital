...
class RandomForestRegressModel:
    ...
    def _training(self, datasets_train: tuple):
        ...
        self.bestRegressor = RandomForestRegressor(n_estimators=self.bestN,
    ...
    def _store(self):
        sio.dump(self.bestRegressor, 'src/models/tree&forests/srcs/forest.pkl')

    def _reload(self):
        self.bestRegressor = sio.load('src/models/tree&forests/srcs/forest.pkl', trusted=True)
...
model = RandomForestRegressModel(cv=5, cvEval=cvEval)